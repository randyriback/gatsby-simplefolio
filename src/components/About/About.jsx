          ...
          <Col md={6} sm={12}>
            <Fade left={isDesktop} bottom={isMobile} duration={1000} delay={1000} distance="30px">
              <div className="about-wrapper__info">
                ...
                <p className="about-wrapper__info-text">
                  {paragraphTwo ||
                    "I’m a full-stack software developer, DJ, and musician based in Beacon, NY. For the last 10 years, I've been exploring the impact of technology within the worlds of art, music, and restaurant culture. When I’m not coding, you can find me curating ambient sounds, exploring hikes upstate, or enjoying natural wine."}
